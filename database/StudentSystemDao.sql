...
Student_Sex nchar(1) default '男' not null check (Student_Sex in('男','女')),	#学生性别
Grade int not null,	#年级
Classe int not null,	#班级
Major_ID varchar(30) not null,	#专业编号
...
insert into tb_Department(Department_ID ,Department_Name) values('22','计算机科学与技术系');
...
insert into tb_Major(Major_ID,Major_Name,Department_ID) values('11','计算机科学与技术专业','22');
insert into tb_Major(Major_ID,Major_Name,Department_ID) values('00','软件工程专业','22');
insert into tb_Major(Major_ID,Major_Name,Department_ID) values('13','网络工程专业','22');
...
/*添加班级*/
insert into tb_Classe(Classe,Grade,Major_ID) values(1,2021,'22');
insert into tb_Classe(Classe,Grade,Major_ID) values(2,2021,'22');
insert into tb_Classe(Classe,Grade,Major_ID) values(3,2021,'22');
insert into tb_Classe(Classe,Grade,Major_ID) values(4,2021,'22');
insert into tb_Classe(Classe,Grade,Major_ID) values(5,2021,'22');
insert into tb_Classe(Classe,Grade,Major_ID) values(6,2021,'22');
insert into tb_Classe(Classe,Grade,Major_ID) values(7,2021,'22');
...
/*添加课程*/
insert into tb_Course(Course_Name,Major_ID,Grade) values ('高等数学','00',2021);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('英语','00',2021);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('数据结构','00',2021);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('计算机组成原理','00',2021);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('面向对象程序设计','00',2021);

insert into tb_Course(Course_Name,Major_ID,Grade) values ('高等数学','12',2022);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('英语','12',2022);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('数据结构','12',2022);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('软件工程导论','12',2022);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('面向对象程序设计','12',2022);

insert into tb_Course(Course_Name,Major_ID,Grade) values ('高等数学','13',2022);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('英语','13',2022);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('数据结构','13',2022);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('计算机网络','13',2022);
insert into tb_Course(Course_Name,Major_ID,Grade) values ('面向对象程序设计','13',2022);
